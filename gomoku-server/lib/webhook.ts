import { type Color, type GameResponse, type Move, type Webhook } from "./gameStore.js";
...
export async function notifyWebhooks(webhooks: Webhook[], response: GameResponse, lastMove?: Move) {
